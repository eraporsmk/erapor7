...
<br />
<p>Nama Peserta Didik : {{strtoupper($pd->nama)}}</p>
...
<div class="strong text-center">KETERANGAN PINDAH SEKOLAH</div>
<br />
<p>Nama Peserta Didik : {{$pd->nama}}</p>
<table border="1" width="100%" class="table">
	<thead>
		<tr>
...
<table border="1" width="100%" class="table">
	...
	<tbody>
		...
		<?php
		$get_prestasi = $pd->anggota_rombel->prestasi()->where('jenis_prestasi', $pres)->get();
		?>
		<tr>
