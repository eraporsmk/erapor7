<template>
  <b-navbar-nav class="nav">
    <b-nav-item
      ...
      :to="bookmark.route"
    >
    <!--b-img :src="appLogoKiri" class="img-fluid" alt="e-Rapor SMK" style="height:50px" /-->
    <h2>SMK CONTOH | 2022/2023 Genap</h2>
    </b-nav-item>
...
<script>
import {
  BNavbarNav, BNavItem, BTooltip, BNavItemDropdown, BFormInput, BDropdownItem, BImg,
} from 'bootstrap-vue'
...
export default {
  components: {
    BNavbarNav, BNavItem, BTooltip, BNavItemDropdown, BFormInput, VuePerfectScrollbar, BDropdownItem, BImg,
  },
  setup() {
    const appLogoKiri = $themeConfig.app.appLogoKiri
