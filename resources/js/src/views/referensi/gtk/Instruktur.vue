<template>
  <b-card>
    ...
    <add-ptk @reload="handleReload" :title="`Tambah Data Instruktur`" :link_excel="`/excel/format_excel_instruktur.xlsx`" :jenis_gtk="`instruktur`"></add-ptk>
  </b-card>
</template>
...
export default {
  ...
  created() {
    this.loadPostsData()
    eventBus.$on('modal-instruktur', this.handleEvent);
  },
  methods: {
    handleEvent(){
