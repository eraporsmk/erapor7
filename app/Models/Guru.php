...
class Guru extends Model
{
	...
	public function gelar_depan(){
		return $this->hasManyThrough(
            ...
            'guru_id',
            'gelar_akademik_id'
        )->where('posisi_gelar', 1)->whereNotIn('gelar_ptk.gelar_akademik_id', [9999, 99999]);
	}
	public function gelar_belakang(){
		return $this->hasManyThrough(
            ...
            'guru_id',
            'gelar_akademik_id'
        )->where('posisi_gelar', 2)->whereNotIn('gelar_ptk.gelar_akademik_id', [9999, 99999])->orderBy('gelar_ptk.gelar_akademik_id', 'DESC');
	}
